...
public:
    ...
    */
    ...
    void Update () {
        UpdateHardwareInput ();
        // SM.Update ();
        PerformanceTestThreeD1 (); // the current robot control procedure
    ...
    void PerformanceTestThreeD1 () {
        ...
        TSM.Add ( & backtrack_from_foosball );
        TSM.Add ( & stop );
        //TSM.Add ( & stop );
        //TSM.Add ( & stop );
...
void DrawEverything () {
    ...
    LCD.SetFontColor (MAGENTA); // ORCHID
...
void mainLoop () {
    ...
    vehicle.SetRotation (RPS.Heading ());
